...
return [
    ...
    */
    ...
    'namespace' => env('SHOPIFY_APP_NAMESPACE', 'fsb'),
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Free Shipping Bar'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '替换成你自己的key'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '替换成你自己的secret'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_themes,write_themes,write_script_tags'),
    ...
    */
    ...
    'scripttags' => [
        ...
        [
            'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', env('APP_URL') . '/pdd/scripttags/pdd.js'),
